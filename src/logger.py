...
class DataLogger:
    ...
    def purge_all(self) -> int:
        """Delete all logged training data and return the number of files removed."""
        removed_files = 0
    ...
    def get_storage_summary(self) -> TrainingDataStorageSummary:
        ...
        summary_targets = []
        if self.audio_dir.exists():
            summary_targets.extend(path for path in self.audio_dir.rglob("*"))
        summary_targets.append(self.metadata_file)
