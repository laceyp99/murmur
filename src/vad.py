...
class WebRTCVADSegmenter:
    ...
    def __init__(
        ...
        self.vad_sample_rate = self._resolve_vad_sample_rate(sample_rate)
        ...
        self.frame_samples = int(self.vad_sample_rate * frame_duration_ms / 1000)
        self.start_padding_samples = int(self.vad_sample_rate * start_padding_ms / 1000)
        self.end_padding_samples = int(self.vad_sample_rate * end_padding_ms / 1000)
        self.silence_samples = int(self.vad_sample_rate * silence_duration_ms / 1000)
        self.min_segment_samples = int(self.vad_sample_rate * min_segment_duration_ms / 1000)
        self.min_output_segment_samples = int(sample_rate * min_segment_duration_ms / 1000)
        self.merge_gap_samples = int(self.vad_sample_rate * merge_gap_ms / 1000)
    ...
    def _resolve_vad_sample_rate(self, sample_rate: int) -> int:
